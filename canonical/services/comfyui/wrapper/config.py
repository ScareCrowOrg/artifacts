...
HUNYUAN3D_GENERATE_TIMEOUT = int(os.getenv("HUNYUAN3D_GENERATE_TIMEOUT", "300"))
HUNYUAN3D_MODEL_NAME = os.getenv("HUNYUAN3D_MODEL_NAME", "hunyuan3d_v2_fp8.safetensors")
