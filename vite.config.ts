...
export default defineConfig({
  ...
  server: {
    ...
    watch: {
      // WHITELIST strategy: Ignore everything except artifact source code
      // This prevents unnecessary recompilation when SCHEMAS.json or other
      // auto-generated files change (e.g., from backend processes)
      ignored: [
        ...
        '**/SCHEMAS.json',              // 🔴 CRITICAL: Auto-generated by backend, triggers infinite recompilation
        '**/SCHEMAS.json.backup',       // Backup of above

        // Everything in canonical EXCEPT:
        // - cell_types/, book_types/, viewers/, shared/ (source code)
        // - *.config.ts (configuration)
        // This uses inverse patterns: monitor ONLY what we need
        '!/canonical/cell_types/**/*.ts',    // ✅ Watch cell source
        '!/canonical/cell_types/**/*.vue',   // ✅ Watch cell components
        '!/canonical/cell_types/**/*.js',    // ✅ Watch cell scripts
        '!/canonical/book_types/**/*.ts',    // ✅ Watch book source
        '!/canonical/book_types/**/*.vue',   // ✅ Watch book components
        '!/canonical/book_types/**/*.js',    // ✅ Watch book scripts
        '!/canonical/viewers/**/*.ts',       // ✅ Watch viewer source
        '!/canonical/viewers/**/*.vue',      // ✅ Watch viewer components
        '!/canonical/viewers/**/*.js',       // ✅ Watch viewer scripts
        '!/canonical/services/**/*.ts',      // ✅ Watch service source
        '!/canonical/services/**/*.js',      // ✅ Watch service scripts
        '!/shared/**/*.ts',                  // ✅ Watch shared utilities
        '!/shared/**/*.js',                  // ✅ Watch shared utilities
        '!/vite.config.ts',                  // ✅ Watch Vite config
        '!/tsconfig.json',                   // ✅ Watch TS config

        // Everything else in canonical/ is ignored (JSON data, images, etc)
        'canonical/**',                      // Default ignore canonical
      ],
